...
![](images/clipboard-990591694.png)

Antes entrenar el modelo.

### Entrenamiento del modelo

![](images/clipboard-1324892658.png)

Se usó Mask R-CNN con backbone ResNet-50 FPN, un modelo de segmentación robusto y estándar. Aquí se configuró las clases (Hoja y Escala), Iteraciones de entrenamiento (3000), Bath size (2 imágenes por iteración, adaptado para GPU de Colab), Learning rat (0.00025), Checkpoints (cada 500 iteraciones), Dataset ("leaf_train"). Al final dió un archivo llamado "model_final.pth" que se usó para la interencia y la aplicaicón interactiva.
...
![](images/clipboard-3902812702.png)

Imagen cargado en Colab:

![](images/clipboard-48678221.png)

Imagen cargada de PC:

![](images/clipboard-419452710.png)
...
![](images/clipboard-4104446463.png)
